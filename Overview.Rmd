...
Of the `r nrow(OAFullList)` records extracted from the honours data base, the match with a wikiData extry with a connection to Australia was `r nrow(wikidataAusMatch)`. Once this was filtered for entries that relate to Australia, we have a final data set of `r nrow(wikipediaMatch)` entries to match against Wikipedia. 
